...
public class ModifyProductMenuController implements Initializable {
    ...
    public ObservableList<Part> originalData=FXCollections.observableArrayList();
    ...
    private void saveProduct(MouseEvent event) throws IOException {
       ...
       if (associatedPartsTblView.getItems().isEmpty())
        {
        ...
        } else if (!associatedPartsTblView.getItems().isEmpty()){
    ...
    public void setProduct(Product product) throws IOException {
        ...
        associatedPartsTblView.setItems(product.getAllAssociatedParts());
        ...
        originalProduct = new Product(product.getId(), product.getName(),product.getPrice(), product.getStock(), product.getMin(), product.getMax());
        for (Part part : product.getAllAssociatedParts())
        {
            originalProduct.addAssociatedPart(part);
        }
        originalData = originalProduct.getAllAssociatedParts();
        for (Part part : transferData)
        {
            System.out.println(part);
        }
